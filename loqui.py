    ...
    def cargarDiccionario(self, fname):
        ...
        if extension == ".txt":
            try:
                ...
                print("-------------------------------------------------------------------")
                print(f"el archivo no se encuentra en la dirreccion indicada o no existe. Intente de nuevo")
                print("-------------------------------------------------------------------")
                return 2
        else:
            cargo = False
    ...
    def corregirTexto(self,finput):
        ...
        if extension == ".txt":
            try:
                ...
                print("-------------------------------------------------------------------")
                print(f"el archivo no se encuentra en la dirreccion indica o no existe. Intente de nuevo")
                print("-------------------------------------------------------------------")    
                return 2
        else:
            print("-------------------------------------------------------------------")
